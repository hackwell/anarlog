...
export type EnhanceUser = { session: Session; participants: Participant[]; template: EnhanceTemplate | null; transcripts: Transcript[]; preMeetingMemo: string; postMeetingMemo: string; previousMeetings: PreviousMeeting[]; slides: SlideText[] }
...
export type PreviousMeeting = { title: string; occurredAt: string; summary: string }
...
export type SlideText = { shownAt: string; text: string }
