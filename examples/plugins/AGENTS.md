...
- Desktop loads installed plugins from `~/Library/Application Support/de.flagbit.sessionecho.dev/plugins`.
...
- If startup is bricked, remove installed plugins directory and restart:
  - `rm -rf ~/Library/Application\ Support/de.flagbit.sessionecho.dev/plugins`
