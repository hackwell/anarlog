...
pub enum SyncError {
    ...
    #[error("Session Echo Pro is required for CloudSync")]
    ProPlanRequired,

    #[error("A newer Session Echo version is required for encrypted CloudSync")]
    ...
    fn into_response(self) -> Response {
        let (status, code, message) = match self {
            ...
            Self::ProPlanRequired => (
                ...
                "Session Echo Pro is required for CloudSync".to_string(),
            ),
            Self::CloudsyncUpgradeRequired => (
                StatusCode::UPGRADE_REQUIRED,
                "cloudsync_upgrade_required",
                "Update Session Echo to continue using encrypted CloudSync".to_string(),
            ),
            ...
            Self::SnapshotChanged => (
                StatusCode::CONFLICT,
                "snapshot_conflict",
                "Shared note changed; update Session Echo and reload before publishing again"
                    .to_string(),
            ),
