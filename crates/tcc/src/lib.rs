...
mod tests {
    ...
    fn test_reset_audio_capture_permission() {
        let result = reset_audio_capture_permission("de.flagbit.sessionecho.nightly");
        println!("reset_audio_capture_permission: {}", result);
    }

    #[test]
    fn test_reset_screen_capture_permission() {
        let result = reset_screen_capture_permission("de.flagbit.sessionecho.nightly");
        println!("reset_screen_capture_permission: {}", result);
    }

    #[test]
    fn test_reset_microphone_permission() {
        let result = reset_microphone_permission("de.flagbit.sessionecho.nightly");
