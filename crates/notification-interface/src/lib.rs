...
impl Notification {
    ...
    pub fn default_action_label(&self) -> &str {
        self.action_label.as_deref().unwrap_or("Open Session Echo")
    }
...
pub fn stop_countdown_text(remaining: Duration) -> String {
    ...
    format!("Session Echo will stop listening in {seconds} seconds.")
}
...
mod tests {
    ...
    fn stop_countdown_copy_matches_macos() {
        let notification = Notification::builder()
            ...
            .message("Session Echo will stop listening soon.")
            .action_label("Stop")
        ...
        assert_eq!(
            ...
            "Session Echo will stop listening in 5 seconds."
        );
        assert_eq!(
